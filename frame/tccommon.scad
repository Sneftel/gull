...
TC_PCB_GUIDE_PINCH_DIAMETER = 1.5;
...
module PCBGuide()
{
    ...
    pn_neg() {
        Rect(TC_PCB_GUIDE_MINOR_WIDTH, TC_PCB_GUIDE_DEPTH, ANCHOR_TC, extraY=EXTRA);
        translate([0, -TC_PCB_GUIDE_DEPTH])
            Rect(TC_PCB_GUIDE_MAJOR_WIDTH, TC_PCB_GUIDE_SLOT_HEIGHT, ANCHOR_BC);
        translate([0, -TC_PCB_GUIDE_DEPTH])
            Rect(TC_LEG_CUTOUT_WIDTH, TC_LEG_CUTOUT_DEPTH, ANCHOR_TC);
        translate([-TC_PCB_GUIDE_MAJOR_WIDTH/2+TC_PCB_GUIDE_PINCH_DIAMETER/2, -TC_PCB_GUIDE_DEPTH+TC_PCB_GUIDE_SLOT_HEIGHT])
            circle(d=TC_PCB_GUIDE_PINCH_DIAMETER);
...
module BodyArm()
{
    pn_pos() Rect(TC_ARM_BASE_WIDTH, TC_ARM_HEIGHT, ANCHOR_TC);
